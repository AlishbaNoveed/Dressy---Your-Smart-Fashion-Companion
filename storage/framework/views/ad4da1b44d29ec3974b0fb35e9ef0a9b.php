...
<main class="pt-90">
              ...
              <div class="accordion-body px-0 pb-0 pt-3 category-list" >
                <ul class="list list-inline mb-0">
                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <input type="checkbox" name="categories" value="<?php echo e($category->id); ?>" class="chk-category"
        ...
        <div class="accordion" id="size-filters">
          <div class="accordion-item mb-4 pb-3">
            ...
            <div id="accordion-filter-size" class="accordion-collapse collapse show border-0"
              ...
              <div class="accordion-body px-0 pb-0">
                <div class="d-flex flex-wrap">
                  <p>Colors on your screen may not exactly match real life due to display settings and lighting.</p>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="500" data-slider-step="5" data-slider-value="[<?php echo e($min_price); ?>,<?php echo e($max_price); ?>]" data-currency="$" />
  ...
  <h2
    ...
    Women's <br /><strong>FASHION</strong></h2>
  <p class="mb-0 animate animate_fade animate_btt animate_delay-5">
    Discover fashion that fits you. From stitched to unstitched, summer to winter, Dressy suggests outfits based on your unique age, skin tone, and preferences. Style has never been this personal.
  </p>
</div>
          ...
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="<?php echo e(route('shop.product.details',['product_slug' =>$product->slug])); ?>l"><?php echo e($product->name); ?></a></h6>
  ...
  <form method="GET" id="frmfilter" action="<?php echo e(route('shop.index')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PMLS\Documents\Final-Year-Project\laravelfyp\resources\views/shop.blade.php ENDPATH**/ ?>