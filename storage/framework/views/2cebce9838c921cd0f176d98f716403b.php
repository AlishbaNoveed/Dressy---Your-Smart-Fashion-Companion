                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4><?php echo e($dashboardData[0]->Total); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4><?php echo e($dashboardData[0]->TotalAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                           ...
                                                           <h4><?php echo e($dashboardData[0]->TotalOrdered); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                           ...
                                                           <h4><?php echo e($dashboardData[0]->TotalOrderedAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                           ...
                                                           <h4><?php echo e($dashboardData[0]->TotalDelivered); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            <div class="body-text mb-2">Delivered Orders Amount</div>
                                                             <h4><?php echo e($dashboardData[0]->TotalDeliveredAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4><?php echo e($dashboardData[0]->TotalCanceled); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4><?php echo e($dashboardData[0]->TotalCanceledAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PMLS\Documents\Final-Year-Project\laravelfyp\resources\views/admin/index.blade.php ENDPATH**/ ?>