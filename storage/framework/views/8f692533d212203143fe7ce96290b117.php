      ...
      <tr>
        ...
        <td class="pname text-center">
          <div class="image mb-1">
            <img src="<?php echo e(asset('uploads/categories')); ?>/<?php echo e($category->image); ?>" alt="<?php echo e($category->name); ?>" class="image d-block mx-auto" style="max-height: 60px;">
          </div>
          <div class="name">
            <a href="#" class="body-title-2 d-block"><?php echo e($category->name); ?></a>
          </div>
        </td>
  ...
  <div class="list-icon-function d-flex justify-content-center align-items-center gap-2">
    ...
    <form action="<?php echo e(route('admin.category.delete', ['id' => $category->id])); ?>" method="POST">
      ...
      <button type="submit" class="btn p-0 border-0 bg-transparent" onclick="return confirm('Are you sure you want to delete this category?')">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            // dangerMode: true,
                ...
                <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PMLS\Documents\Final-Year-Project\laravelfyp\resources\views/admin/categories.blade.php ENDPATH**/ ?>