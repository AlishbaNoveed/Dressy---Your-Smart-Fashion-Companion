...
<head>
    ...
    <title>{{ config('app.name', 'Dressy') }}</title>
    ...
    <div class="container d-flex align-items-center h-100">
      ...
      <div class="logo mx-auto">
        <a href="{{route('home.index')}}">
          <img src="{{asset('assets/images/logo.png')}}" alt="Fashion Store" class="logo__image d-block" />
        </a>
      </div>
      ...
      <div class="d-flex align-items-center gap-3">
        <a href="{{route('wishlist.index')}}" class="header-tools__item">
          ...
          @if(Cart::instance("wishlist")->content()->count()>0) 
            <span class="cart-amount d-block position-absolute">{{Cart::instance("wishlist")->content()->count()}}</span>
          @endif     
        </a>

        <a href="{{route('cart.index')}}" class="header-tools__item">
          <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <use href="#icon_cart" />
          </svg>
          @if(Cart::instance('cart')->content()->count()>0)
            <span class="cart-amount d-block position-absolute">{{Cart::instance('cart')->content()->count()}}</span>
          @endif
        </a>
      </div>
    </div>
    ...
    <nav class="header-mobile__navigation navigation d-flex flex-column w-100 position-absolute top-100 bg-body overflow-auto">
      ...
      <div class="container">
        <div class="overflow-hidden">
          <ul class="navigation__list list-unstyled position-relative">
            ...
            <li class="navigation__item">
              <a href="{{route('recommendation.index')}}" class="navigation__link">Recommendation</a>
            </li>
            <li class="navigation__item">
      ...
      <div class="border-top mt-auto pb-2">
        <div class="customer-links container mt-4 mb-2 pb-1">
          ...
          @else
            <a href="{{Auth::user()->utype === 'ADM' ? route('admin.index'): route('user.index')}}" class="d-flex align-items-center text-decoration-none">
              <svg class="d-inline-block align-middle" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon_user" />
              </svg>
    ...
    <div class="container">
      <div class="header-desk header-desk_type_1">
        ...
        <div class="header-tools d-flex align-items-center">
          ...
          @guest
          <div class="header-tools__item hover-container">
            <a href="{{route('login')}}" class="header-tools__item d-flex align-items-center gap-2">
              <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon_user" />
              </svg>
          ...
          @else
          <div class="header-tools__item hover-container">
            <a href="{{Auth::user()->utype === 'ADM' ? route('admin.index'): route('user.index')}}" class="header-tools__item d-flex align-items-center gap-2">
              <span class="d-none d-xl-inline fw-medium">{{Auth::user()->name}}</span>
              <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon_user" />
              </svg>
            </a>
          ...
          <a href="{{route('cart.index')}}" class="header-tools__item header-tools__cart position-relative">
            <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <use href="#icon_cart" />
            </svg>
            @if(Cart::instance('cart')->content()->count()>0)
...
">
  <a href="{{route('home.index')}}">
    <img src="{{asset('assets/images/logo.png')}}" alt="Fashion Store" class="logo__image d-block" style="max-width: 140px;" />
  </a>
</div>
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            ...
            <!-- <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Dresses</a></li> -->
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Casual</a></li>
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Partywear</a></li>
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Formal</a></li>
            <!-- <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Winter</a></li> -->
            <!-- <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Shop All</a></li> -->
          </ul>
        </div>
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            ...
            <!-- <li class="sub-menu__item"><a href="{{Auth::check() ? (Auth::user()->utype === 'ADM' ? route('admin.index'): route('user.index')) : route('login')}}" class="menu-link menu-link_us-s">My Account</a></li> -->
        ...
        <!-- <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Casuals</a></li>
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Partywear</a></li>
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Summer</a></li>
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Winter</a></li>
            <li class="sub-menu__item"><a href="{{route('shop.index')}}" class="menu-link menu-link_us-s">Shop All</a></li>
          </ul>
        </div> -->
