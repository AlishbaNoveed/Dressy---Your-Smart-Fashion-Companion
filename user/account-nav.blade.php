<ul class="account-nav">
            ...
            <li><a href="{{route('show.user.address')}}" class="menu-link menu-link_us-s">Addresses</a></li>
            <li><a href="{{route('account.details')}}" class="menu-link menu-link_us-s">Account Details</a></li>
            <li><a href="{{route('show.wishlist')}}" class="menu-link menu-link_us-s">Wishlist</a></li>
            <li>
